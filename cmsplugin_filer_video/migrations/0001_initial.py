    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', filer.fields.image.FilerImageField(null=True, to='filer.Image', help_text='preview image file', related_name='filer_video_image', blank=True, verbose_name='image', on_delete=models.deletion.CASCADE)),
                ('movie', filer.fields.file.FilerFileField(null=True, to='filer.File', help_text='use .flv file or h264 encoded video file', blank=True, verbose_name='movie file', on_delete=models.deletion.CASCADE)),
            ],
            options={
                'abstract': False,
            },
